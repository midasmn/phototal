...
$title = f_get_tran($db_conn,$language_id,'title-pay');
if($name)
{
  $title = $name.' | '.$title;
}
$keywords = f_get_tran($db_conn,$language_id,'keywords-pay');
$description = f_get_tran($db_conn,$language_id,'description-pay');
...
$rtn_tab2 = f_get_tab_img($db_conn,0,2,"img-responsive img-circle img-responsive-overwrite");
// 登録数
